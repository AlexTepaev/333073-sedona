...
* Студент: [Александр Тепаев](https://up.htmlacademy.ru/htmlcss/22/user/333073).
* Наставник: `Кекс`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/333073-sedona) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
